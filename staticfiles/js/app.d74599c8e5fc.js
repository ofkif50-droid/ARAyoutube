...
form.addEventListener('submit', async (e) => {
  ...
  try {
    // Request download (360p) to get progress_url + title
    ...
    // Poll progress to get the title
    ...
    // Stream video directly from YouTube via iframe embed — plays with video+audio
